...
Open **Settings > Connectors**, select the connector, and disconnect it. Disconnecting removes Babbily's access to that app. It does not delete content inside the connected app.
